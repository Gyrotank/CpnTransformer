...
public final class CpnMlDefinitions {
    
    public static final String CPN_TOOLS_VERSION = "4.0.1";
    
    public static final String DECLARATION_COLSET_UNIT = "colset UNIT = unit;";
